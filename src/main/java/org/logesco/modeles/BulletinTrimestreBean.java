 ...
 *
 */
public class BulletinTrimestreBean implements Serializable {
    ...
    private List<MatiereGroupe1TrimestreBean> matieresGroupe1Trimestre;
    private List<MatiereGroupe2TrimestreBean> matieresGroupe2Trimestre;
    private List<MatiereGroupe3TrimestreBean> matieresGroupe3Trimestre;
	...
	/**
	 * @return the matieresGroupe1Trimestre
	 */
	public List<MatiereGroupe1TrimestreBean> getMatieresGroupe1Trimestre() {
		return matieresGroupe1Trimestre;
	}


	/**
	 * @param matieresGroupe1Trimestre the matieresGroupe1Trimestre to set
	 */
	public void setMatieresGroupe1Trimestre(List<MatiereGroupe1TrimestreBean> matieresGroupe1Trimestre) {
		this.matieresGroupe1Trimestre = matieresGroupe1Trimestre;
	}


	/**
	 * @return the matieresGroupe2Trimestre
	 */
	public List<MatiereGroupe2TrimestreBean> getMatieresGroupe2Trimestre() {
		return matieresGroupe2Trimestre;
	}


	/**
	 * @param matieresGroupe2Trimestre the matieresGroupe2Trimestre to set
	 */
	public void setMatieresGroupe2Trimestre(List<MatiereGroupe2TrimestreBean> matieresGroupe2Trimestre) {
		this.matieresGroupe2Trimestre = matieresGroupe2Trimestre;
	}


	/**
	 * @return the matieresGroupe3Trimestre
	 */
	public List<MatiereGroupe3TrimestreBean> getMatieresGroupe3Trimestre() {
		return matieresGroupe3Trimestre;
	}


	/**
	 * @param matieresGroupe3Trimestre the matieresGroupe3Trimestre to set
	 */
	public void setMatieresGroupe3Trimestre(List<MatiereGroupe3TrimestreBean> matieresGroupe3Trimestre) {
		this.matieresGroupe3Trimestre = matieresGroupe3Trimestre;
	}
